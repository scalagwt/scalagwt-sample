...
trait ChangeHandlers {
  ...
  class RichHasChangeHandlers(o: HasChangeHandlers) {
    ...
    def onChange[T](body: => T) = o.addChangeHandler(body2changeHandler(() => body))
  }
}
...
trait ClickHandlers {
  ...
  class RichHasClickHandlers(o: HasClickHandlers) {
    ...
    def onClick[T](body: => T) = o.addClickHandler(body2clickHandler(() => body))
  }
}
...
trait KeyUpHandlers {
  ...
  class RichHasKeyUpHandlers(o: HasKeyUpHandlers) {
    ...
    def onKeyUp[T](body: => T) = o.addKeyUpHandler(body2keyUpHandler(() => body))
  }
}
...
trait KeyDownHandlers {
  ...
  implicit def body2keyDownHandler(body: () => Unit): KeyDownHandler =
    new KeyDownHandler {
      def onKeyDown(event: KeyDownEvent) = body
    }
  ...
  class RichHasKeyDownHandlers(o: HasKeyDownHandlers) {
    ...
    def onKeyDown[T](body: => T) = o.addKeyDownHandler(body2keyDownHandler(() => body))
  }
}
